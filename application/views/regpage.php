...
<div class="container">
    <div id="loginWindow" class="card card-container card-login">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo base_url('mc/regist') ?>" class="form-signin" id="login-form" method="post">
            ...
            <a href="<?php echo base_url('mc/index'); ?>" class="forgot-password">
                Sudah Punya Akun?
            </a>
        </div>
    </div><!-- /card-container -->
